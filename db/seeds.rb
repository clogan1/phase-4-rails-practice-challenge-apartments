...
a1 = Apartment.create(number: 4109, name: 'a1')
a2 = Apartment.create(number: 1107, name: 'a2')
a3 = Apartment.create(number: 2409, name: 'a3')
a4 = Apartment.create(number: 1110, name: 'a4')
a5 = Apartment.create(number: 7103, name: 'a5')
